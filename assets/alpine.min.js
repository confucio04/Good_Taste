    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      cartButtons.forEach(function (button) {
          button.addEventListener("click", function () {
              ...
              var quantity = quantityInput ? quantityInput.value : 1; // Obtén la cantidad del input o utiliza 1 por defecto

              // Obtén más información del producto
              var productTitle = productContainer.querySelector("h2").innerText;
              var productImage = productContainer.querySelector("img").getAttribute("src");
              var productDescription = productContainer.querySelector(".expandable").innerText;

              // Construye la URL de redirección a la página del carrito con parámetros
              var cartUrl = "/cart";
              var redirectUrl = cartUrl + "?add=" + productId + "&quantity=" + quantity;

              // Almacena información adicional del producto en localStorage para que la página del carrito pueda acceder a ella
              localStorage.setItem("addedProduct", JSON.stringify({
                  id: productId,
                  title: productTitle,
                  image: productImage,

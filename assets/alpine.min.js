...
//# sourceMappingURL=/sm/44afe343e2d1648d1350ab98ed40031d7c91d6246d1aa6dadb2f143c24a5612c.map
    ...
    //     // Verificar si el clic ocurrió en un elemento con la clase 'expandable'
    //     if (target.classList.contains('expandable')) {
    //         const realHeight = target.scrollHeight + 'px';
    //         target.style.maxHeight = target.style.maxHeight ? null : realHeight;
    //     }
    // });
    ...
    //         addToCart(
    //             'Club Mini',
    //             'New wines, shipped directly to you every other month! Our December "sipment" features a delicious line-up of mini wines selected by winemaker Matt Smith, that pair perfectly with holiday gatherings. Sign up today to save up to 20% off on all online purchases+ free Ground Shipping on member shipments.',
    //             54.0,
    //             '//cdn.shopify.com/s/files/1/0683/0007/9353/files/product-3_e95e5aaa-270e-46d9-9474-b140d88006d3.webp?v=1702779465&width=300'
    //         );
    //     });
    // });
    ...
    //     window.location.href = "/cart/add?id=" + encodeURIComponent(title) + "&description=" + encodeURIComponent(description) + "&price=" + price + "&image=" + encodeURIComponent(image);
    // }

    
// // Ejemplo de valores de parámetros
// const description = "New wines, shipped directly to you every other month! Our December 'shipment' features a delicious line-up of mini wines selected by winemaker Matt Smith, that pair perfectly with holiday gatherings.";
// const id = "Club Mini";
// const image = "//cdn.shopify.com/s/files/1/0683/0007/9353/files/product-3_e95e5aaa-270e-46d9-9474-b140d88006d3.webp?v=1702779465&width=300";
// const oseid = "i9DmwLkSbn3iMhBG1Q75QiA8";
// const price = 54;

// // Codificar los valores de los parámetros
// const encodedDescription = encodeURIComponent(description);
// const encodedId = encodeURIComponent(id);
// const encodedImage = encodeURIComponent(image);
// const encodedOseid = encodeURIComponent(oseid);
// const encodedPrice = encodeURIComponent(price);

// // Construir la URL con los valores codificados
// const url = `https://i-goodtaste.myshopify.com/cart/add?description=${encodedDescription}&id=${encodedId}&image=${encodedImage}&oseid=${encodedOseid}&price=${encodedPrice}`;

// // Usar la URL en tu solicitud o hacer lo que necesites con ella
// console.log(url);
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function addToCart(productId) {
            // Puedes ajustar la URL y otros parámetros según la API de Shopify
            var addToCartUrl = "https://i-goodtaste.myshopify.com/cart/add?id=" + encodeURIComponent(productId);

            // Redirigir a la página de carrito o realizar otras acciones necesarias

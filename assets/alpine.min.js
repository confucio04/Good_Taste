...
document.addEventListener('DOMContentLoaded', function() {
    ...
    cardInfos.forEach(cardInfo => {
      cardInfo.addEventListener('click', function() {
        ...
        const realHeight = paragraph.scrollHeight + 'px';

        paragraph.style.maxHeight = paragraph.style.maxHeight ? null : realHeight;
      });
    });
  });
  function redirectToCart() {
    // Reemplaza "url-de-tu-carrito" con la URL correcta de tu carrito en Shopify

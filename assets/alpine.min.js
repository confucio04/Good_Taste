    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      cartButtons.forEach(function (button) {
          button.addEventListener("click", function () {
              ...
              var quantity = 1; // Puedes ajustar la cantidad según tus necesidades

              // Hace una solicitud a la API de Shopify para agregar el producto al carrito
              fetch("/cart/add.js", {
                  method: "POST",
                  headers: {
              ...
              .then(data => {
                  // Verifica si se agregó correctamente al carrito

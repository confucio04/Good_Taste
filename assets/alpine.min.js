...
document.addEventListener('DOMContentLoaded', function() {
  const productDescriptions = document.querySelectorAll('.expandable');

  productDescriptions.forEach(description => {
    description.addEventListener('click', function() {
      const realHeight = description.scrollHeight + 'px';

      description.style.maxHeight = description.style.maxHeight ? null : realHeight;
    });
  });
});
  ...
  function redirectToCart() {
    console.log("Redireccionando a /cart");

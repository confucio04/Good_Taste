...
//# sourceMappingURL=/sm/44afe343e2d1648d1350ab98ed40031d7c91d6246d1aa6dadb2f143c24a5612c.map
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      function addToCart(productId, productPrice) {
          ...
          var encodedPrice = encodeURIComponent(productPrice);

          fetch('https://i-goodtaste.myshopify.com/cart/add', {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/x-www-form-urlencoded',
              },
              body: `id=${encodedId}&quantity=1&price=${encodedPrice}`,
          })
          .then(response => {
              // Manejar la respuesta aquí (puede ser necesario redirigir a la página del carrito)
          })
          .catch(error => {
